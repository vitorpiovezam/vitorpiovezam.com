        ...
        <section class="about-section" id="about">
          <div class="about-grid">
            <div class="about-left">
              ...
              <div class="about-photo">
                ...
                <div class="about-photo-links">
                  <a href="https://github.com/vitorpiovezam" target="_blank" class="photo-link" title="GitHub">
                  ...
                  <a href="https://www.linkedin.com/in/vitorpiovezam/" target="_blank" class="photo-link" title="LinkedIn">
            ...
            <div class="about-right">
              <!-- Flickr link above the iframes -->
              <div class="flickr-header-link">
                <a href="https://www.flickr.com/people/190210202@N04/" target="_blank" class="flickr-link-row">
                  <svg class="flickr-link-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M0 12a6 6 0 1012 0A6 6 0 100 12zm12 0a6 6 0 1012 0 6 6 0 10-12 0z"/></svg>
                  <span>My photos on Flickr</span>
                </a>
              </div>
