  ...
  template: `
      <div [ngClass]="{'container': true, 'dark-theme': darkTheme, 'light-theme': !darkTheme}">
        <div class="about">
          <app-about>
            <div>
              <button class="menu-item theme-toggler" [ngClass]="{'dark-theme': !darkTheme, 'light-theme': darkTheme}">
            ...
            <div class="icons">
              <p>
                ...
                <a href="https://www.linkedin.com/in/vitorpiovezam/" target="_blank"><svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg></a>
                <a href="https://twitter.com/vitorpiovezam" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" version="1.1"><path d="M178.57 127.15 290.27 0h-26.46l-97.03 110.38L89.34 0H0l117.13 166.93L0 300.25h26.46l102.4-116.59 81.8 116.59h89.34M36.01 19.54H76.66l187.13 262.13h-40.66"/></svg></a>
              </p>
            </div>
          </app-about>
        </div>
