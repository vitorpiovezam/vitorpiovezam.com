...
@Component({
  ...
  <div class="profile">
    ...
    <div class="text">
      ...
      <p>So in recent years I have developed my skills in logic, typescript and cloud computing. Acting as Fullstack Angular/Node, currently as Senior Software Engineer at <a target="_blank"href="https://www.picpay.com">PicPay</a>.</p>
      <p class="icons">
        <ng-content>
        </ng-content>
      </p>
      <img class="photo" src="/assets/images/perfil.jpg">
    </div>
  </div>
  `,
